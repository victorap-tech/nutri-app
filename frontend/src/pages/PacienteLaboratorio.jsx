  ...
  return (
    <div className="page">
      ...
      <div className="card">
        ...
        <div className="grid">
          ...
          <div>
            ...
            <input
              value={form.colesterol_total}
              onChange={(e) =>
                setField("colesterol_total", e.target.value)
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              value={form.hdl}
              onChange={(e) => setField("hdl", e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <input
              value={form.ldl}
              onChange={(e) => setField("ldl", e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setField("trigliceridos", e.target.value)
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              value={form.tsh}
              onChange={(e) => setField("tsh", e.target.value)}
            />
          </div>
      ...
      <div className="card">
        ...
        {labs.length === 0 ? (
          <p className="muted">
            Todavía no hay registros de laboratorio.
          </p>
        ) : (
